...
ganadoresGR14[8,2] = "KAUSACHUN CUSCO" #CUSCO
ganadoresGR14[22,2] = "FUERZA POPULAR" #SAN MARTIN
```
...
data_finalGP14 = left_join(data_finalGP14, primero[c(1,14)], by="TXUBIGEO") #join 
```
...
data_finalGP14 = left_join(data_finalGP14, segundo[c(1,14)], by="TXUBIGEO") #join 
```
...
data_finalGP14=data_finalGP14[-c(12,13)]
```
...
data_finalGL14 = left_join(data_finalGL14, primero[c(1,14)], by="TXUBIGEO") #join 
```
...
data_finalGL14 = left_join(data_finalGL14, segundo[c(1,14)], by="TXUBIGEO") #join 
```
...
data_finalGL14=data_finalGL14[-c(12,13)]
```
