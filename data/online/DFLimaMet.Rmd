...
g <- ggplot(data=data,
  ...
  geom_bar(stat="identity") + xlab("") + ylab("Nuevos Followers")+
    theme(text = element_text(size=10))+ coord_flip() + ggtitle("Momento 1: Antes del debate") +
  ylim(0, 4000)
```
...
d <- ggplot(data=data,
  ...
  geom_bar(stat="identity") + xlab("") + ylab("Nuevos Followers")+
    theme(text = element_text(size=10))+ coord_flip() + ggtitle("Momento 2: Despues del debate")+
  ylim(0, 4000)
```
