...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data[data$setiembre >0,], aes(x=Nuevos_Followers, y=setiembre, size=following_Sep, color=antiguedad)) + geom_point() + ggtitle("Utilizan twitter los candidatos con mayor intencion de voto en Lima?") + ylab("% Intencion de voto") + xlab("Nuevos Followers") + 
...
graph <- ggplot(data[data$setiembre >0,], aes(x=Nuevos_Followers, y=setiembre, size=following_Sep, color=antiguedad,text = hovertxt))+ geom_point() + ggtitle("Utilizan twitter los candidatos con mayor intencion de voto en Lima?") + ylab("% Intencion de voto") + xlab("Nuevos Followers") + 
